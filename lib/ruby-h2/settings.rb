  ...
  module Settings
    ...
    class << self
      ...
      def pairs_from frame
        ...
        raise ConnectionError.new(Error::FRAME_SIZE_ERROR, "SETTINGS payload should be multiple of 6 bytes, got #{bytes.bytesize} (#{bytes.bytesize % 6})") if bytes.bytesize % 6 != 0
        while !bytes.empty?
